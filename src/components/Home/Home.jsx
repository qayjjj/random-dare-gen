...
function Home() {
  ...
  return (
    <div className="home-container flex flex-col items-center mt-32">
      ...
      <div className="mt-6 w-1/4 text-black text-xl flex flex-col items-center relative">
      ...
      <div
        id="start-button"
        className="start-button 'w-1/4 sm:w-1/8 lg:w-1/3' mt-12 h-20 px-12 rounded-full flex place-content-center items-center justify-between"
